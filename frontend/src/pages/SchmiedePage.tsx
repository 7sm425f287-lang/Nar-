                    ...
                    {group.items.map((backendAgent, index) => {
                      ...
                      return (
                        <motion.button
                          ...
                          transition={{ duration: 0.28, ease, delay: Math.min(index, 8) * 0.035 }}
                          whileHover={{ y: -4, scale: 1.008 }}
                          onClick={() => handleBindBackendAgent(backendAgent.id)}
                          className={`matrix-card matrix-card-${backendAgent.category} ${
                            isSelected ? 'matrix-card-selected' : ''
                          }`}
                        >
                          ...
                          <div className="matrix-card-head">
                            ...
                            <div className="matrix-card-badges">
                              <span className="matrix-card-category">{group.label}</span>
                              {isSelected && <span className="matrix-card-active">steuert {activeTarget?.title}</span>}
                            </div>
                          </div>
                          ...
                          <div className="matrix-card-meta">
                            <div className="matrix-card-targets">
                              {backendAgent.backendTargets.map((target) => (
